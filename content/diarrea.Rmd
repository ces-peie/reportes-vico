...
```{r epidemic-curve-hospital, fig.width=12, fig.height=15}
plot_epidemic_curve_labeled(diarrea_min, show_site_type = "hospital")
```

### Clínicas

```{r epidemic-curve-clinic, fig.width=12, fig.height=15}
plot_epidemic_curve_labeled(diarrea_min, show_site_type = "centro de salud")
```
